...
<?php
	...
	if (isset($_POST['submit'])) {
		...
		$query = "INSERT INTO order_details (name,quntity,email,address) VALUES ('".$uname."', '".$Password."','".$Email."','".$Adress."')";
	...
	<header>
        <nav>
         ...
         <div class="hero-text-box">
             <h1>This is , <br> submit section.</h1>
...
<section class="form">
                ...
                <div class="row">
                    ...
                    <form action="Validateorder" method="post" class="contact-form" name="myForm">
                        ...
                        <div class="row">
                            <div class="col span-1-of-3">
                                <label for="phone num" >Reciver's Mobile Number</label>
                            </div>
                            <div class="col span-2-of-3">
                        ...
                        <div class="row">
                            <div class="col span-1-of-3">
                                <label for="phone num" >quantity</label>
                            </div>
                            <div class="col span-2-of-3">
